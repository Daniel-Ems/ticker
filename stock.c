...
//inserts by tickers
stock *
Insert (stock * root, int cost, char *company, char *ticker)
{
  int result;
...
//Inserts by cost
stock *
Insert_num (stock * root, int cost, char *company, char *ticker)
{
...
stock *
new_tree (stock * tree, stock * second,
